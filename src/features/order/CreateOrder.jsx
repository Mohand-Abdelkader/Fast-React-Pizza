        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="w-full px-4 py-2 text-sm transition-all border rounded-full border-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
            />
          </div>
        </div>
